...
export function SectionCard({
  ...
  return (
    <section
      className={`mei-card relative overflow-hidden rounded-lg p-4 sm:p-5 ${
    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="flex min-w-0 items-center gap-2.5">
          <span
            className={`inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-white/10 ${toneClasses.chip}`}
          >
